...
const TABS = [
  ...
  { id: 'combat', label: '전투', html: `
    ...
    <h4>선원 사기 — 백병전 전투력을 좌우합니다</h4>
    <p>상단 바 ⚓ 사기 수치(0~100%)는 백병전 전투력에 직접 곱해집니다 — 0%면 절반, 100%면 그대로입니다. 오르내리는 경로는 다음과 같습니다.</p>
    <ul>
      <li><b>올리는 법 — 급여는 이제 완전 자동, 바다 위에서도 지급됩니다</b>: 선원 급여(선원 수×0.25두캇, 하루치)가 항해일자가 넘어갈 때마다 <b>위치와 무관하게</b> 자동으로 나갑니다 — 항구에 있든 먼바다 한복판이든 하루에 한 번, 낼 수 있으면 사기 <b>+15</b>가 즉시 회복됩니다(골드가 모자라 못 내면 오히려 <b>-20</b>). 항구에 도킹하면 그날 아직 안 냈을 때만 그 자리에서 지급되며, 추가로 신규 선원 충원까지 함께 이뤄집니다.</li>
      <li><b>올리는 법 — 맑은 날씨로 항해</b>: 폭풍·안개가 전혀 없는 완전히 잔잔한 날엔, 항해하는 동안 초당 +0.15씩 저절로 아주 천천히 회복됩니다(선체 내구도도 함께 회복).</li>
      <li><b>올리는 법 — "사기충천" 선박 스킬</b>: 일부 대형·초대형 전투함(솔레유 루아얄, 철갑 아타케부네 등)이 원래부터 갖고 있는 고유 스킬로, 격침에 승리할 때마다 사기 <b>+8</b>이 추가로 붙습니다. 조선소에서 살 수 있는 부품이 아니라 그 배 자체에 내장된 특성입니다.</li>
      <li><b>깎이는 것들</b>: 전투 중 피격당할 때마다(포격 피탄 1회당 -4, 백병전 패배 시 -4), 그리고 식량 고갈(-15/일)·식수 고갈(-20/일)로도 떨어집니다. 급여를 못 낸 채 그날이 넘어가도 -20입니다.</li>
    </ul>
  ` },
