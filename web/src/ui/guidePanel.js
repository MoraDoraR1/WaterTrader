...
const TABS = [
  ...
  { id: 'combat', label: '전투', html: `
    ...
    <ul>
      <li><b>올리는 법 — 입항 후 급여 지급</b>: 항구에 도킹하면 자동으로 선원 급여(선원 수×0.5두캇)를 내고, 낼 수 있으면 사기 <b>+15</b>가 즉시 회복됩니다(골드가 모자라 못 내면 오히려 <b>-20</b>).</li>
      ...
      <li><b>깎이는 것들</b>: 전투 중 피격당할 때마다(포격 피탄 1회당 -4, 백병전 패배 시 -4), 그리고 식량 고갈(-15/일)·식수 고갈(-20/일)로도 떨어집니다. 급여를 못 낸 채 도킹해도 -20입니다.</li>
    </ul>
  ` },
