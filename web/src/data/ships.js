...
export const SHIPS = [
  // ── 소형선 (탐사/정찰용, 15세기 포르투갈/스페인 카라벨 계열) ──
  {
    ...
    country: 'PT', era: '1450s', speed: 11, turnRate: 70, hp: 320, cargo: 60, cannons: 5, cannonSlotTiers: [2], crew: 20, price: 800,
    desc: '포르투갈 항해자들이 아프리카 서안 탐사에 사용한 삼각돛 경쾌선.',
  },
  { id: 'pinta', name: '핀타 (Pinta)', class: 'small', role: 'adventure', type: 'caravel',
    country: 'ES', era: '1492', speed: 12, turnRate: 68, hp: 340, cargo: 65, cannons: 5, cannonSlotTiers: [2], crew: 22, price: 850,
    desc: '콜럼버스 함대의 쾌속 카라벨. 기동성이 뛰어남.' },
  { id: 'nina', name: '니냐 (Niña)', class: 'small', role: 'adventure', type: 'caravel',
    country: 'ES', era: '1492', speed: 12, turnRate: 72, hp: 310, cargo: 55, cannons: 5, cannonSlotTiers: [2], crew: 20, price: 820,
    desc: '콜럼버스 함대 중 가장 민첩했던 소형 카라벨.' },
  { id: 'barinel', name: '바리넬 (Barinel)', class: 'small', role: 'trade', type: 'caravel',
    country: 'PT', era: '1420s', speed: 10, turnRate: 60, hp: 300, cargo: 85, cannons: 2, cannonSlotTiers: [1], crew: 18, price: 700,
    desc: '초기 포르투갈 연안 교역선. 노와 돛을 함께 사용.' },
  { id: 'caravela_redonda', name: '카라벨라 레돈다 (Caravela Redonda)', class: 'small', role: 'combat', type: 'caravel',
    country: 'PT', era: '1470s', speed: 11, turnRate: 58, hp: 380, cargo: 70, cannons: 5, cannonSlotTiers: [2], crew: 26, price: 950,
  ...
  { id: 'galea_sottile', name: '갈레아 소틸레 (Galea Sottile)', class: 'small', role: 'adventure', type: 'galley',
    country: 'IT', era: '1500s', speed: 13, turnRate: 90, hp: 260, cargo: 30, cannons: 2, cannonSlotTiers: [1], crew: 120, price: 900,
  ...
  { id: 'galera_real', name: '갈레라 레알 (Galera Real)', class: 'medium', role: 'combat', type: 'galley',
    country: 'ES', era: '1571', speed: 10, turnRate: 75, hp: 480, cargo: 50, cannons: 7, cannonSlotTiers: [2, 1], crew: 180, price: 1600,
  ...
  { id: 'galeazza_veneziana', name: '갈레아짜 (Galeazza)', class: 'large', role: 'combat', type: 'galley',
    country: 'IT', era: '1571', speed: 8, turnRate: 42, hp: 900, cargo: 70, cannons: 20, cannonSlotTiers: [2, 2, 2, 2], crew: 300, price: 3200,
  ...
  { id: 'galeazza_reale', name: '갈레아짜 레알레 (Galeazza Reale)', class: 'xlarge', role: 'combat', type: 'galley',
    country: 'ES', era: '1588', speed: 7, turnRate: 30, hp: 1300, cargo: 90, cannons: 30, cannonSlotTiers: [2, 2, 2, 2, 2, 2], crew: 400, price: 5200,
  ...
  { id: 'nau_santa_maria', name: '나오 산타마리아 (Nau Santa María)', class: 'medium', role: 'trade', type: 'carrack',
    country: 'ES', era: '1492', speed: 10, turnRate: 45, hp: 620, cargo: 200, cannons: 10, cannonSlotTiers: [2, 2], crew: 40, price: 2200,
    desc: '콜럼버스의 기함. 카라벨보다 크고 화물 적재에 유리한 나오(캐럭)선.' },
  { id: 'caravel_pinnace', name: '피나스 (Pinnace)', class: 'medium', role: 'adventure', type: 'caravel',
    country: 'EN', era: '1500s', speed: 14, turnRate: 58, hp: 560, cargo: 150, cannons: 10, cannonSlotTiers: [2, 2], crew: 45, price: 2400,
    desc: '영국 해군이 애용한 다목적 쾌속 중형선.' },
  { id: 'cog', name: '코게 (Hanseatic Kogge)', class: 'medium', role: 'trade', type: 'carrack',
    country: 'HAN', era: '1400s', speed: 8, turnRate: 40, hp: 700, cargo: 220, cannons: 7, cannonSlotTiers: [2, 1], crew: 35, price: 2000,
    desc: '한자동맹이 북해·발트해 교역에 사용한 견고한 상선.' },
  { id: 'fluyt', name: '플라위트 (Fluyt)', class: 'medium', role: 'trade', type: 'fullrig',
    country: 'NL', era: '1590s', speed: 11, turnRate: 48, hp: 640, cargo: 290, cannons: 7, cannonSlotTiers: [2, 1], crew: 30, price: 2600,
  ...
  { id: 'caravel_war', name: '카라벨라 데 아르마다 (Caravela de Armada)', class: 'medium', role: 'combat', type: 'caravel',
    country: 'PT', era: '1500s', speed: 12, turnRate: 50, hp: 660, cargo: 140, cannons: 18, cannonSlotTiers: [3, 1], crew: 48, price: 2500,
  ...
  { id: 'baltimore_schooner', name: '볼티모어 스쿠너 (Baltimore Schooner)', class: 'small', role: 'adventure', type: 'schooner',
    country: 'EN', era: '1790s', speed: 15, turnRate: 66, hp: 420, cargo: 110, cannons: 5, cannonSlotTiers: [2], crew: 32, price: 2100,
  ...
  { id: 'topsail_schooner', name: '톱세일 스쿠너 (Topsail Schooner)', class: 'medium', role: 'combat', type: 'schooner',
    country: 'NL', era: '1800s', speed: 13, turnRate: 54, hp: 700, cargo: 180, cannons: 10, cannonSlotTiers: [2, 2], crew: 55, price: 3200,
  ...
  { id: 'galeao_sao_martinho', name: '갈레온 산 마르틴 (San Martín)', class: 'large', role: 'combat', type: 'galleon',
    country: 'ES', era: '1580s', speed: 9, turnRate: 32, hp: 1400, cargo: 400, cannons: 38, cannonSlotTiers: [4, 1, 1, 1], crew: 92, price: 6500,
    desc: '스페인 무적함대 기함급 갈레온. 강력한 현측 포열을 갖춤.' },
  { id: 'madre_de_deus', name: '마드레 데 데우스 (Madre de Deus)', class: 'large', role: 'trade', type: 'carrack',
    country: 'PT', era: '1590s', speed: 8, turnRate: 28, hp: 1550, cargo: 600, cannons: 31, cannonSlotTiers: [3, 2, 2, 2], crew: 85, price: 7000,
    desc: '동방 교역으로 막대한 부를 실어나른 포르투갈 대형 캐럭.' },
  { id: 'east_indiaman', name: '이스트 인디아맨 (East Indiaman)', class: 'large', role: 'trade', type: 'fullrig',
    country: 'NL', era: '1600s', speed: 10, turnRate: 34, hp: 1300, cargo: 580, cannons: 31, cannonSlotTiers: [3, 2, 2, 2], crew: 80, price: 6800,
    desc: '동인도회사의 향신료 무역 전용 대형 상선.' },
  { id: 'revenge', name: '리벤지 (Revenge)', class: 'large', role: 'combat', type: 'galleon',
    country: 'EN', era: '1570s', speed: 11, turnRate: 36, hp: 1250, cargo: 350, cannons: 39, cannonSlotTiers: [3, 3, 2, 1], crew: 95, price: 7200,
    desc: '영국 해군의 갈레온형 전열함. 기동성과 화력을 겸비.' },
  { id: 'galeone_veneziano', name: '갈레오네 (Galeone Veneziano)', class: 'large', role: 'adventure', type: 'galleon',
    country: 'IT', era: '1560s', speed: 9, turnRate: 34, hp: 1350, cargo: 420, cannons: 36, cannonSlotTiers: [3, 3, 1, 1], crew: 88, price: 6600,
  ...
  { id: 'caravela_maior', name: '카라벨라 마이오르 (Caravela Maior)', class: 'large', role: 'trade', type: 'caravel',
    country: 'PT', era: '1500s', speed: 10, turnRate: 44, hp: 900, cargo: 320, cannons: 14, cannonSlotTiers: [2, 2, 1, 1], crew: 60, price: 4200,
  ...
  { id: 'opium_clipper', name: '오피움 클리퍼 (Opium Clipper)', class: 'small', role: 'adventure', type: 'clipper',
    country: 'EN', era: '1830s', speed: 16, turnRate: 52, hp: 380, cargo: 90, cannons: 5, cannonSlotTiers: [2], crew: 18, price: 3400,
  ...
  { id: 'tea_clipper', name: '티 클리퍼 (Tea Clipper)', class: 'medium', role: 'trade', type: 'clipper',
    country: 'EN', era: '1850s', speed: 18, turnRate: 40, hp: 900, cargo: 260, cannons: 7, cannonSlotTiers: [2, 1], crew: 34, price: 8200,
  ...
  { id: 'clipper_thermopylae', name: '클리퍼 테르모필레 (Thermopylae)', class: 'large', role: 'adventure', type: 'clipper',
    country: 'EN', era: '1868', speed: 19, turnRate: 34, hp: 1100, cargo: 300, cannons: 8, cannonSlotTiers: [1, 1, 1, 1], crew: 40, price: 9500,
    desc: '역사상 가장 빠른 범선 중 하나로 꼽히는 대형 클리퍼.' },
  { id: 'sobraon', name: '소브라온 (Sobraon)', class: 'xlarge', role: 'trade', type: 'clipper',
    country: 'EN', era: '1866', speed: 17, turnRate: 26, hp: 1500, cargo: 480, cannons: 12, cannonSlotTiers: [1, 1, 1, 1, 1, 1], crew: 45, price: 12500,
  ...
  { id: 'henry_grace_a_dieu', name: '헨리 그레이스 어 듀 (Henry Grace à Dieu)', class: 'xlarge', role: 'combat', type: 'shipline',
    country: 'EN', era: '1514', speed: 7, turnRate: 20, hp: 2600, cargo: 700, cannons: 79, cannonSlotTiers: [4, 3, 3, 2, 2, 2], crew: 180, price: 15000,
    desc: '"그레이트 해리"라 불린 잉글랜드 최대의 초대형 캐럭 전함.' },
  { id: 'vasa', name: '바사 (Vasa)', class: 'xlarge', role: 'combat', type: 'shipline',
    country: 'SE', era: '1628', speed: 7, turnRate: 18, hp: 2400, cargo: 500, cannons: 63, cannonSlotTiers: [3, 3, 3, 2, 2, 2], crew: 150, price: 14000,
  ...
  { id: 'sovereign_of_the_seas', name: '소버린 오브 더 시즈 (Sovereign of the Seas)', class: 'xlarge', role: 'combat', type: 'shipline',
    country: 'EN', era: '1637', speed: 8, turnRate: 22, hp: 2800, cargo: 600, cannons: 102, cannonSlotTiers: [4, 4, 4, 1, 1, 1], crew: 200, price: 18000,
  ...
  { id: 'santisima_trinidad', name: '산티시마 트리니다드 (Santísima Trinidad)', class: 'xlarge', role: 'combat', type: 'shipline',
    country: 'ES', era: '1769', speed: 7, turnRate: 16, hp: 3200, cargo: 550, cannons: 138, cannonSlotTiers: [4, 4, 4, 4, 2, 2], crew: 220, price: 22000,
    desc: '스페인 해군이 자랑한 사상 최대급 4층 포열 전함.' },
  { id: 'soleil_royal', name: '솔레유 루아얄 (Soleil Royal)', class: 'xlarge', role: 'combat', type: 'shipline',
    country: 'FR', era: '1670', speed: 7, turnRate: 19, hp: 2900, cargo: 520, cannons: 103, cannonSlotTiers: [4, 4, 3, 3, 2, 1], crew: 210, price: 19500,
