...
// class: small(소형) / medium(중형) / large(대형) / xlarge(초대형)
...
export const SHIPS = [
  ...
  {
    id: 'caravela_lateen', name: '카라벨라 (Caravela Latina)', class: 'small',
  ...
  { id: 'pinta', name: '핀타 (Pinta)', class: 'small',
    country: 'ES', era: '1492', speed: 12, turnRate: 68, hp: 340, cargo: 65, cannons: 4, crew: 22, price: 850,
    desc: '콜럼버스 함대의 쾌속 카라벨. 기동성이 뛰어남.' },
  { id: 'nina', name: '니냐 (Niña)', class: 'small',
    country: 'ES', era: '1492', speed: 12, turnRate: 72, hp: 310, cargo: 55, cannons: 4, crew: 20, price: 820,
    desc: '콜럼버스 함대 중 가장 민첩했던 소형 카라벨.' },
  { id: 'barinel', name: '바리넬 (Barinel)', class: 'small',
    country: 'PT', era: '1420s', speed: 10, turnRate: 65, hp: 300, cargo: 70, cannons: 2, crew: 18, price: 700,
    desc: '초기 포르투갈 연안 교역선. 노와 돛을 함께 사용.' },
  { id: 'caravela_redonda', name: '카라벨라 레돈다 (Caravela Redonda)', class: 'small',
    country: 'PT', era: '1470s', speed: 11, turnRate: 60, hp: 350, cargo: 80, cannons: 6, crew: 24, price: 950,
    desc: '가로돛을 추가해 원양 항해 능력을 높인 개량형 카라벨.' },

  // ── 중형선 (교역/균형형) ──
  { id: 'nau_santa_maria', name: '나오 산타마리아 (Nau Santa María)', class: 'medium',
    country: 'ES', era: '1492', speed: 10, turnRate: 45, hp: 620, cargo: 180, cannons: 10, crew: 40, price: 2200,
    desc: '콜럼버스의 기함. 카라벨보다 크고 화물 적재에 유리한 나오(캐럭)선.' },
  { id: 'caravel_pinnace', name: '피나스 (Pinnace)', class: 'medium',
    country: 'EN', era: '1500s', speed: 13, turnRate: 55, hp: 560, cargo: 150, cannons: 12, crew: 45, price: 2400,
    desc: '영국 해군이 애용한 다목적 쾌속 중형선.' },
  { id: 'cog', name: '코게 (Hanseatic Kogge)', class: 'medium',
    country: 'HAN', era: '1400s', speed: 8, turnRate: 40, hp: 700, cargo: 220, cannons: 6, crew: 35, price: 2000,
    desc: '한자동맹이 북해·발트해 교역에 사용한 견고한 상선.' },
  { id: 'fluyt', name: '플라위트 (Fluyt)', class: 'medium',
    country: 'NL', era: '1590s', speed: 11, turnRate: 48, hp: 640, cargo: 260, cannons: 8, crew: 30, price: 2600,
    desc: '네덜란드가 개발한 대량 물자 수송 특화 상선.' },
  { id: 'caravel_war', name: '카라벨라 데 아르마다 (Caravela de Armada)', class: 'medium',
    country: 'PT', era: '1500s', speed: 12, turnRate: 50, hp: 600, cargo: 140, cannons: 14, crew: 42, price: 2500,
    desc: '무장을 강화한 포르투갈 호위용 카라벨.' },

  // ── 대형선 (전투/장거리 교역) ──
  { id: 'galeao_sao_martinho', name: '갈레온 산 마르틴 (San Martín)', class: 'large',
    country: 'ES', era: '1580s', speed: 9, turnRate: 32, hp: 1400, cargo: 400, cannons: 36, crew: 90, price: 6500,
    desc: '스페인 무적함대 기함급 갈레온. 강력한 현측 포열을 갖춤.' },
  { id: 'madre_de_deus', name: '마드레 데 데우스 (Madre de Deus)', class: 'large',
  ...
  { id: 'east_indiaman', name: '이스트 인디아맨 (East Indiaman)', class: 'large',
    country: 'NL', era: '1600s', speed: 10, turnRate: 34, hp: 1300, cargo: 550, cannons: 30, crew: 80, price: 6800,
    desc: '동인도회사의 향신료 무역 전용 대형 상선.' },
  { id: 'revenge', name: '리벤지 (Revenge)', class: 'large',
  ...
  { id: 'galeone_veneziano', name: '갈레오네 (Galeone Veneziano)', class: 'large',
    country: 'IT', era: '1560s', speed: 9, turnRate: 30, hp: 1350, cargo: 420, cannons: 34, crew: 88, price: 6600,
    desc: '지중해 교역과 방어를 겸한 베네치아 대형 갈레온.' },

  // ── 초대형선 (기함급) ──
  { id: 'henry_grace_a_dieu', name: '헨리 그레이스 어 듀 (Henry Grace à Dieu)', class: 'xlarge',
  ...
  { id: 'santisima_trinidad', name: '산티시마 트리니다드 (Santísima Trinidad)', class: 'xlarge',
  ...
  { id: 'soleil_royal', name: '솔레유 루아얄 (Soleil Royal)', class: 'xlarge',
