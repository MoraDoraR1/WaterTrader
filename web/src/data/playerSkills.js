...
//
// 학문(고고학/지리학/천문학)은 완전히 다른 성격이라 이 학습·장착 경제에서 제외된다 — 배울
// 필요 없이 처음부터 갖고 있고, 시전 개념도 없다. 오직 "발견"(조사·관측, G키) 시에만 성장하며,
// 그 성장 폭은 발견물 자체의 랭크(=minSkillLevel)에 비례한다(data/compendium.js
// rewardForRank 참고). 이 랭크는 순수하게 (1) 퀘스트 수주 조건과 (2) 발견 가능 조건 수치로만
// 쓰이고, 어떤 능동 효과도 갖지 않는다.
